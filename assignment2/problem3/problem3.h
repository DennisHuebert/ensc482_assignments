...
std::vector<float> leastSquaresGoalsNumberOfBackers;
std::vector<float> leastSquaresAmountPledgedNumberOfBackers;
std::vector<float> leastAmountPledgedGoals;
...
double calculateVarience(double, std::vector<float>);
std::vector<float> calculateLeastSquaresCoeff(float rXY, double xMean, double yMean, double xSD, double ySD);
